...
<html lang="en">
  <head>
    ...
    <title>Approval For Statutory Assignment</title>
    <style>
      * {
        padding: 0;
        margin: 0;
    ...
    <div class="container">
      <div class="inner-container">
        ...
        <section class="revenue-statement">
          <p class="content">
            I am directed to refer to your application on the above subject
            matter and to convey to you the approval of His Excellency, the
            Governor on your Assignment with the particulars shown below:
          </p>
        </section>
        ...
        <section class="revenue-list">
          <table class="list-table info-table">
            <tbody>
              <tr class="data-particulars">
                <td class="key">Former Owner:</td>
                <td class="big-key-values bold">
                  ${inputData.assignorName}
                </td>
              </tr>
              <tr class="data-particulars">
                <td class="key">Former Owner Address:</td>
                <td class="small-key-values bold">
                  ${inputData.assignorAddress}
                </td>
              </tr>
              <tr class="data-particulars">
                <td class="key">New Owner:</td>
                <td class="big-key-values bold">
                  ${inputData.assigneeName}
                </td>
              </tr>
              <tr class="data-particulars">
                <td class="key">New Owner Address:</td>
                <td class="small-key-values bold">
                  ${inputData.assigneeAddress}
                </td>
              </tr>
              <tr class="data-particulars">
          ...
          <section class="revenue-statement">
            ...
            <ol>
              <li>
                Submission of satisfactory deed of assignment before the
