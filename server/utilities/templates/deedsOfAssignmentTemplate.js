      ...
      <div class="inner-container">
        ...
        <section class="clear deed-statement">
          <p>
            ...
            <span class="bold">${inputData.assignorName}</span> whose address is
            <span class="bold">${
              inputData.assignorAddress
          ...
          <p>
            AND WHEREAS the holder of the said title
            <span class="bold">${inputData.assignorName}</span> whose address is
            <span class="bold">${inputData.assignorAddress}</span>
            has/have applied for and received an approval to assign all rights
            and responsibilities over said property to
            <span class="bold">${inputData.assigneeName},</span> whose address
            is
            <span class="bold"
              >${inputData.assigneeAddress}</span
            >
            ...
            of assginment registered as No <span class="bold">${
              inputData.newAssignmentParticulars.regNum
            }</span> at
            Page <span class="bold">${
              inputData.newAssignmentParticulars.page
            }</span> in Volume
            <span class="bold">${
              inputData.newAssignmentParticulars.volume
            }</span> of the Digital Register in the
